...
/** Sada čistých SVG ikon (styl lucide) — jednotný vzhled napříč aplikací. */
const PATHS: Record<string, ReactNode> = {
  ...
  // Řazení: dvě šipky proti sobě — pořadí balení proti pořadí přehledu
  ...
  // Zmenšení okna: šipky dovnitř, proti `expand`
