...
const ALLOWED_INVOKE = [
  ...
  'ai:usage', 'digest:get', 'digest:facts', 'digest:ask', 'digest:archive', 'digest:old', 'digest:pdf', 'ga4:get', 'ga4:save', 'ga4:test', 'ga4:apps', 'ga4:diagnostics', 'quota:get', 'mail:cleanupScan', 'mail:cleanupRun', 'shell:openUrl',
